...
class API {
  ...
  constructor() {
    this.url = 'https://boundless-server-5xs0.onrender.com/api/'
  }
}
...
// 在類別的建構函式中，設置了後端 API 服務器的基本 URL，這裡設置為 https://boundless-server-5xs0.onrender.com/api/，這應該是後端 API 服務器的根路徑。
